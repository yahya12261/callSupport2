...
const personService_1 = require("../app/services/personService");
const Person_1 = require("../app/models/entities/Person");
const PersonController_1 = __importDefault(require("../app/controllers/PersonController"));
const router = (0, express_1.Router)();
const upload = (0, multer_1.default)();
const Service = new personService_1.PersonService(Person_1.Person);
const Controller = new PersonController_1.default();
